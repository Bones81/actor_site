    ...
    return (
        <>
            <section id="about" className="about-closed" > 
                ...
                <p className="about-text">Nathan attended Princeton University where he earned a degree in music (theory and composition) and received a certificate in theatre. There he served as president of the Princeton University Players and music director of The Princeton Tigertones.</p>
                ...
                <p className='about-text'>Handy with a computer, Nathan is also a certified software engineer and web developer. You can <a href="http://www.nathanfreeman.com" target="_blank" rel="noreferrer">view his portfolio here</a>.</p>
